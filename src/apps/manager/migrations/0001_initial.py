    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.IntegerField(choices=src.utils.enums.Countries.choices),
                ),
                (
                    "fifa_version",
                    models.IntegerField(choices=src.utils.enums.FIFAVersion.choices),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "available_teams",
                    models.ManyToManyField(related_name="tournaments", to="manager.team"),
                ),
                (
                    "participants",
                    models.ManyToManyField(related_name="tournaments", to=settings.AUTH_USER_MODEL),
                ),
            ],
        ),
        migrations.CreateModel(
